...
`/projects/ALT_LAS` adresinde klonlanan ALT_LAS projesinin yapısı incelenmiştir. Özellikle aşağıdaki modüller ve alanlar, CUDA entegrasyonu için potansiyel adaylar olarak görünmektedir:
