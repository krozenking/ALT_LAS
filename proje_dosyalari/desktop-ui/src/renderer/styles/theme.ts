...
const styles = {
  global: (props) => {
      ...
      return {
        body: {
          ...
          color: props.colorMode === 'light'
            ? 'highContrast.light.text'
            : 'highContrast.dark.text',
          transition: 'none', // Disable transitions in high contrast mode
        },
        ...
        '*:focus-visible': {
          outline: `2px solid ${colors.primaryHc[500]}`,
          outlineOffset: '2px',
          boxShadow: 'none',
        },
        // High contrast selection
        '::selection': {
          background: 'primaryHc.500',
          color: 'background.highContrast',
        },
        ...
        '::-webkit-scrollbar-track': {
          background: 'background.highContrast',
        },
        '::-webkit-scrollbar-thumb': {
          background: 'borderHc.500',
          border: `2px solid ${colors.background.highContrast}`,
        },
    ...
    return {
      ...
      '::-webkit-scrollbar-track': {
        background: props.colorMode === 'light' ? '#f1f1f1' : '#2d3748',
      },
      '::-webkit-scrollbar-thumb': {
        background: '#888',
      },
